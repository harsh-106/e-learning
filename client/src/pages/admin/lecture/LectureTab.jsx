    ...
    <Card>
        <CardHeader className='flex justify-between' >
            <div>
             ...
             <CardDescription>Make changes and see the updation..</CardDescription>
            </div>
        ...
        <CardContent>
            <div>
                <Label>Title</Label>
                <Input type="text" value={lectureTitle} onChange={(e)=> setLectureTitle(e.target.value)} placeholder="Title of lecture"  />
            </div>
            <div className='my-5'>
                <Label>Video <span className='text-red-500'>*</span> </Label>
                <Input className='w-fit' onChange={fileChangeHandler} type="file" accept='video/*' placeholder="Title of lecture"  />
            </div>
